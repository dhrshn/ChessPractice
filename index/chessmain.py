...
def loadImages():
    ...
    for piece in pieces:
        IMAGES[piece] = p.transform.scale(p.image.load("D:/ChessPractice/index/images/" + piece + ".png"), (SQUARE_SIZE, SQUARE_SIZE))
...
def main():
    ...
    while running:
        ...
        if move_made:
            ...
            valid_moves = game_state.getValidMoves()  # Update valid moves after a move is made
            move_made = False
            animate = False
            move_undone = False
